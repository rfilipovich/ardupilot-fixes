...
#define THISFIRMWARE "ArduCopter V3.1.5-my"
/*
...
static AP_Baro_MS5611 barometer(&AP_Baro_MS5611::i2c);
   ...
   #endif
  #elif CONFIG_BARO == AP_BARO_LPS331AP
   #if CONFIG_LPS331AP_SERIAL == AP_BARO_LPS331AP_I2C
static AP_Baro_LPS331AP barometer(&AP_Baro_LPS331AP::i2c);
   #else
    #error Unrecognized CONFIG_LPS331AP_SERIAL setting.
   #endif
  #endif
