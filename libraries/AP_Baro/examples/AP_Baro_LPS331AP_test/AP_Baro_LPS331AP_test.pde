...
AP_Baro_LPS331AP baro(&AP_Baro_LPS331AP::i2c);
static uint32_t timer;

void setup()
{
    hal.console->println("APM2 LPS331AP Barometer library test");
...
#else // Non-APM2
#warning AP_Baro_LPS331AP_test built as stub for APM1
void setup () {}
void loop () {}
#endif
